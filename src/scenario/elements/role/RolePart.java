 ...
 * 
 */
package scenario.elements.role;
 ...
 *
 */
public class RolePart implements IElement
{
	...
	public void generateElement(StringBuilder stringBuilder, int tabLevel)
	{
		...
		// First scenario line
		stringBuilder.append(currentLineTab).append(Constant.ROLE_PART_NAME).append(Constant.NEW_LINE);
