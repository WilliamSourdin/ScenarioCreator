 ...
 * 
 */
package scenario.elements.dialog;
 ...
 *
 */
public class DialogPart implements IElement
{
	...
	public void generateElement(StringBuilder stringBuilder, int tabLevel)
	{
		...
		// First scenario line
		stringBuilder.append(currentLineTab).append(Constant.DIALOG_PART_NAME).append(Constant.NEW_LINE);
